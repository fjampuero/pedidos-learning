package com.codigo.pedido.entregas.infrastructure.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, Object> consumerFactory(
        ...
        config.put("spring.json.trusted.packages", "com.codigo.pedido.entregas.infrastructure.messaging.event");
        config.put("spring.json.value.default.type",
                "com.codigo.pedido.entregas.infrastructure.messaging.event.PagoAprobadoEvent");
