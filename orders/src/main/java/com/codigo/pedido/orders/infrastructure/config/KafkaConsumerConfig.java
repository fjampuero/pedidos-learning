...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, Object> consumerFactory(
        ...
        config.put("spring.json.trusted.packages", "com.codigo.pedido.orders.infrastructure.messaging.event");
        config.put("spring.json.value.default.type",
                "com.codigo.pedido.orders.infrastructure.messaging.event.PagoAprobadoEvent");
